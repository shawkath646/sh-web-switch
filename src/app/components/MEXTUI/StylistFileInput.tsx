...
const StylistFileInput: React.FC<StylistFileInputPropsType> = ({ labelText, selectedName, ...props }) => {
    ...
    return (
        <>
            <button type="button" onClick={handleClick} className="w-40 lg:w-64 space-y-2 outline-none">
                ...
                <p className="truncate overflow-hidden">{selectedName}</p>
            </button>
